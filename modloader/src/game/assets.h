...
// build. The override table is a flat key to plaintext map; the mod supplies decoded bytes and the
// loader reencodes non-.cub data (via assetcodec) so the game's own decode reconstructs it. Per mod
