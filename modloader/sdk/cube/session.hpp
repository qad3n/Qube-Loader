...
namespace cube
{
    ...
    public:
        ...
        bool refresh()
        {
            m_valid = m_api && m_api->session.get(m_api, &m_data) != 0;
            return m_valid;
        }
        ...
        bool set(SessionField field, int value) const
        {
            return m_api && m_api->session.setField(m_api, static_cast<int32_t>(field), value) != 0;
        }
        bool setMultiplayer(bool multiplayer) const
        {
            return set(SessionField::NetworkMode, multiplayer ? 1 : 0);
        }
    ...
    public:
        ...
        bool refresh()
        {
            m_valid = m_api && m_api->ui.get(m_api, &m_data) != 0;
            return m_valid;
        }
        ...
        bool set(UiField field, bool open) const
        {
            return m_api && m_api->ui.setField(m_api, static_cast<int32_t>(field), open ? 1 : 0) != 0;
        }
